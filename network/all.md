...
## 三. 传输层
### 3.1 TCP报文段的首部格式
<img src="../images/15297611898077.jpg" width="650px" >
...
### 3.2 UDP报文段首部格式
<img src="../images/15297612276666.jpg" width="650px" >
...
#### 1）TCP对应的协议
 ...
 - **FTP(21)**：定义了**文件传输协议**，使用21端口。常说某某计算机开了FTP服务便是启动了文件传输服务。下载文件，上传文件，都要用到FTP服务。
